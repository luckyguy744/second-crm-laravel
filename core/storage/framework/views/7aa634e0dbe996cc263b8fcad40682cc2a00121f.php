			<footer class="foot">
				<div class="container-fluid">					
					<div class="copyright" align="center">
					    ...
					    <?php echo e(__('messages.cpyrght')); ?> &#169; <a href="/"><?php echo e($settings->site_title); ?></a> <?php echo e(date("Y")); ?>. <?php echo e(__('messages.all_rght_resrvd')); ?>
	...
	<script type="text/javascript">
		...
		var adminStatisticsChart2 = new Chart(ctx2, {
			...
			data: {
				...
				[ 
					{
						label: "<?php echo e(__('messages.invt_stats')); ?>",
						borderColor: '#08C',
	 ...
	 //    }); 
		...
		var wd_stats = new Chart(ctx, {
			...
			data: {
				...
				[ 
					{
						label: "<?php echo e(__('messages.wthdrwl_stat')); ?>",
						borderColor: '#FFF',
...
</html><?php /**PATH /home/gcibrokers/client.gcibrokers.net/core/resources/views/admin/atlantis/footer.blade.php ENDPATH**/ ?>