<div id="succ" class="container popmsgContainer">
    <div class="row wd_row_pad">
      ...
      <div class="col-md-4 popmsg-mobile pop_msg_col" align="Center">
        <div class="panel-heading">
          <h3><?php echo e(__('messages.tkt_msg')); ?></h3>               
          <hr>
        </div>
        ...
        <div>
          <span style="">            
            <a id="succ_close" href="javascript:void(0)" class="btn btn-success"><?php echo e(__('messages.msg_okay')); ?></a>        
          </span>
          <br><br><br><br>
        </div>
        <!-- close btn -->
  ...
  <div id="errr" class="container popmsgContainer" >
    <div class="row wd_row_pad" >
      ...
      <div class="col-md-4 popmsg-mobile pop_msg_col"  align="Center">
        ...
        <div>
          <span style="">            
            <a id="errr_close" href="javascript:void(0)" class="btn btn-danger"><?php echo e(__('messages.msg_okay')); ?></a>        
          </span>
          <br><br><br><br>
        </div>
        <!-- close btn -->
          ...
          <div class="sparkline8-list shadow-reset mg-tb-30" >
              <div class="sparkline8-hd" >
                  <div class="main-sparkline8-hd">
                      <h1><?php echo e(__('messages.read_msg')); ?></h1>
                  </div>
              </div>
              <div class="">
                  <div class="" >
  ...
  </div><?php /**PATH /home/gcibrokers/client.gcibrokers.net/core/resources/views/user/inc/alert.blade.php ENDPATH**/ ?>